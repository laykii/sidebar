<template>
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Lyka</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://scontent.fcrk1-3.fna.fbcdn.net/v/t1.6435-9/204111383_4045564235499027_5737489704467723724_n.jpg?_nc_cat=106&ccb=1-3&_nc_sid=09cbfe&_nc_eui2=AeEKpi-lwFy5MgKZhv6auDFw35Cx9knWslzfkLH2SdayXP0xat9wk4ZbOvQSvIiWLb1q6hDEDpMIFqUdrlflgsK-&_nc_ohc=Ti3jy848ZPYAX-vnqxf&_nc_ht=scontent.fcrk1-3.fna&oh=27df6b2b85b11d076a0fa1e352bd9bad&oe=612DBDA5" alt="avatar"/>
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Lyka</h4>
            </div>
        </div>
    </div>
        </div>
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Lyka</a>
                </div>
